...
export const BlockBoardView: React.FC<BlockBoardViewProps> = ({
  ...
  return (
    <div className="block-board-shell relative w-full max-w-[390px] mx-auto select-none flex flex-col min-h-0">
      {/* Outer Gaming Frame with Midnight Navy and subtle Indigo outline */}
      <div className="block-board-frame relative bg-[#090e23] p-2 rounded-2xl border-2 border-[#1c2754] shadow-2xl shadow-black/80 flex items-center justify-center min-h-0">
        ...
        <div
          ...
          className="block-puzzle-grid grid grid-cols-10 gap-1 aspect-square bg-[#050816] p-1.5 rounded-xl border border-[#141d40] touch-none relative overflow-hidden"
            ...
            row.map((cellVal, c) => {
              ...
              return (
                <div
                  ...
                  className={`relative rounded-[5px] flex items-center justify-center transition-all duration-100 cursor-pointer overflow-hidden select-none ${
                    hasBlock
