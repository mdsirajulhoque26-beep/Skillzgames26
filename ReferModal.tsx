      ...
      >
        ...
        <div className="bg-gradient-to-br from-emerald-900/60 to-indigo-950 p-4 rounded-2xl border border-emerald-500/30 text-center mb-4">
          ...
          <p className="text-xs text-slate-300 mt-1">
            আপনার রেফারেল কোড ব্যবহার করে বন্ধু রেজিস্টার করে কমপক্ষে ৳{Number(refSettings.minDeposit || 0).toFixed(0)} ডিপোজিট এবং ১ম Pro ম্যাচ খেললে আপনার Gaming Balance-এ বোনাস যোগ হবে।
          </p>
        </div>
